...
{
 "use strict";
 var Starchan,Web,Client,WebSharper,Obj,UI,Var$1,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,ListModel,Unchecked,Starchan$Web_Templates,Handler,Var,ConcreteVar,Snap,System,Guid,Collections,List,SC$1,Client$1,Templates,Doc,JavaScript,Pervasives,Abbrev,Fresh,Dictionary,View,Object,AttrProxy,CheckedInput,Numeric,HashSet,Seq,TemplateInitializer,EventTarget,Node,JS,DictionaryUtil,Enumerator,T,SC$2,WindowOrWorkerGlobalScope,Docs,SC$3,DocElemNode,CharacterData,Storage,Elt,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Array,ArrayStorage,Attrs$1,AttrModule,List$1,T$1,Strings,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$4,HashSetUtil,BindVar,SC$5,SC$6,AppendList,SC$7,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$8,CT,HashSet$1,String,CancellationTokenSource,DomNodes,Queue,Char,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,console,Math,Date;
 Starchan=Global.Starchan=Global.Starchan||{};
 Web=Starchan.Web=Starchan.Web||{};
 ...
 Starchan$Web_Templates=Global.Starchan$Web_Templates=Global.Starchan$Web_Templates||{};
 ...
 SC$1=Global.StartupCode$Starchan_Web$Client=Global.StartupCode$Starchan_Web$Client||{};
 ...
 {
  var newName,a,b,t,_this,L,_this$1,p,i;
  newName=Var$1.Create$1("foo");
  a=(b=(t=(_this=(L=Doc.Convert(function(name)
  {
   ...
   return(b$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push({
    ...
    $0:"name",
    $1:name
   }),_this$2)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],Starchan$Web_Templates.listitem(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  },Client.People().v),(_this$1=new ProviderBuilder.New$1(),(_this$1.h.push({
   $:0,
   $0:"listcontainer",
   $1:L
   ...
   $0:"name",
   $1:newName
  }),_this)),(t.h.push(Handler.EventQ2(t.k,"add",function()
  {
   return t.i;
  },function()
  {
   ...
   newName.Set("");
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["name",0]]),(i=new TemplateInstance.New(p[1],Starchan$Web_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Starchan$Web_Templates.listitem=function(h)
 {
 ...
 Starchan$Web_Templates.main=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
